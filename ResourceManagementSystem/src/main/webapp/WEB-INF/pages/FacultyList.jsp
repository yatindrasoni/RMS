...
<h2 class="container  text-center text-primary"
	...
	<b><span class="glyphicon glyphicon-th-list"></span>&emsp;<s:message
			code="label.listFaculty"></s:message></b>
</h2>
	...
	<table class="table table-inverse table-striped">
		<c:if test="${!empty list}">
			<tr>
				...
				<th><span class="glyphicon glyphicon-book"></span> <s:message
						code="label.primary" /></th>
				
				<th><span class="glyphicon glyphicon-book"></span> <s:message
						code="label.secondary" /></th>
			...
			<c:forEach items="${list}" var="faculty" varStatus="ct">
				<tr>
					...
					<td><c:out value="${faculty.programName}" /></td>
					<td><c:out value="${faculty.primarySubject}" /></td>
					<td><c:out value="${faculty.secondarySubject}" /></td>
					...
					<td><a href="${editUrl}${faculty.id}"><span
